                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        ...
                        <a href="edit-parkir.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-success">EDIT</a>
                        <a href="jam-keluar.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary">UPDATE JAM KELUAR</a>
